    ...
    return (
        <>
            ...
            <nav className={"mobile-nav" + (hamburgerOpen ? " is-active" : "")}>
                ...
                />
                <p>
                    <span>Hi there &mdash;</span> I'm a {calculate_age(new Date(2002, 5, 13))}-year-old Software Engineer from Ireland. I'm currently in the process of finishing up my degree in Computer Science and Linguistics at Trinity College Dublin and working on my startup <a href="https://clove.ie" className="bio-link">clove.ie</a>
                </p>
                ...
                <ul>
                    <li>
                        ...
                        <a href="mailto:rian@paradaux.io">rian@paradaux.io</a>
                    </li>
                </ul>
                <div className="links">
